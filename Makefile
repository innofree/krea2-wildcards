...
deploy-preview-dry-run: preview
	python3 scripts/deploy_remote_wildcards.py --source build/impact-wildcards/krea2_complete_pack.yaml --evidence tests/reports/deployments/expansion_preview_v0_9_4-dry-run.json

deploy-preview: preview
	python3 scripts/deploy_remote_wildcards.py --source build/impact-wildcards/krea2_complete_pack.yaml --evidence tests/reports/deployments/expansion_preview_v0_9_4-apply.json --apply
...
remote-style-refill-calibration:
	python3 scripts/run_remote_catalog_batch.py --catalog catalog/style_expansion.yaml --templates catalog/expansion_templates.yaml --status generated --style-id style_pack_expansion_minimal_quiet_mineral_muted_weathered_ink_contemplative_air_lost_and_found_complete_style --style-id style_pack_expansion_rounded_graphic_low_contrast_pastel_glazed_luminous_contemplative_air_etched_accent_complete_style --output tests/reports/expansion_style_refill_calibration_v0_9_3 --resume --submit

remote-generated-screen:
	python3 scripts/run_remote_catalog_batch.py --catalog catalog/style_expansion.yaml --templates catalog/expansion_templates.yaml --status generated --output tests/reports/expansion_style_refill_v0_9_4 --resume --submit

remote-testing-retest:
	python3 scripts/run_remote_catalog_batch.py --catalog catalog/style_expansion.yaml --templates catalog/expansion_templates.yaml --status testing --seed 4004 --seed 5005 --output tests/reports/expansion_style_refill_retest_v0_9_4 --resume --submit

review-style-screen:
	python3 scripts/build_contact_sheets.py tests/reports/expansion_style_refill_v0_9_4/scorecard.csv --catalog catalog/style_expansion.yaml --expected-seeds 3 --styles-per-sheet 10 --overwrite
