...
.PHONY: phase7-axis-matrix phase7-axis-calibration remote-phase7-axis phase7-axis-stage-a phase7-axis-sheets phase7-axis-apply
...
# validation-only change or `make check` rejects it as an outside edit.
# CATALOG defaults to the axis plural spelling; override when they differ.
phase7-axis-apply:
